<!-- Auto-generated from agents/apply-template.agent.md — do not edit -->
---
name: "apply-template"
description: "You apply the Claude Code project template to the current project. The user has already downloaded or cloned the template into a temp folder inside this project. You read from that temp folder, interactively merge files into the project, then delete the temp folder."
---
